...
public static class T
{
    ...
    public static Dictionary<string, object> MapOf(string k1, object v1) =>
        new()
        {
            [k1] = v1
        };

    public static Dictionary<string, object> MapOf(string k1, object v1, string k2, object v2) =>
        new()
        {
            [k1] = v1,
            [k2] = v2
    ...
    public static Dictionary<string, object> MapOf(string k1, object v1, string k2, object v2, string k3, object v3) =>
        new()
        {
            [k1] = v1,
            [k2] = v2,
