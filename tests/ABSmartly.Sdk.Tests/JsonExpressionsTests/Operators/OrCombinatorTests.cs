...
public class OrCombinatorTests: OperatorTestBase
{
    ...
    {
        _combinator.Combine(Evaluator, T.ListOf<object>(true, false, true)).Should().Be(true);
        Mock.Get(Evaluator).Verify(e => e.BooleanConvert(true), Times.Once);
        Mock.Get(Evaluator).Verify(e => e.Evaluate(true), Times.Once);
    ...
    public void TestCombine()
    {
        ...
        _combinator.Combine(Evaluator, T.ListOf<object>(true, false)).Should().Be(true);
        _combinator.Combine(Evaluator, T.ListOf<object>(false, true)).Should().Be(true);
