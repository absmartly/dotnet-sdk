...
{
    [TestCase("", 0x00000000, (uint)0x00000000)]
    [TestCase(" ", 0x00000000, (uint)0x7ef49b98)]
    [TestCase("t", 0x00000000, (uint)0xca87df4d)]
    ////[TestCase("te", 0x00000000, 0xedb8ee1b)]
    //[TestCase("tes", 0x00000000, (long)0x0bb90e5a)]
    ////[TestCase("test", 0x00000000, 0xba6bd213)]
    //[TestCase("testy", 0x00000000, (long)0x44af8342)]
    ////[TestCase("testy1", 0x00000000, 0x8a1a243a)]
    ////[TestCase("testy12", 0x00000000, 0x845461b9)]
    //[TestCase("testy123", 0x00000000, (long)0x47628ac4)]
    ////[TestCase("special characters açb↓c", 0x00000000, 0xbe83b140)]
    //[TestCase("The quick brown fox jumps over the lazy dog", 0x00000000, (long)0x2e4ff723)]
    ...
    //[TestCase("", 0x00000001, (long)0x514e28b7)]
    //[TestCase(" ", 0x00000001, (long)0x4f0f7132)]
    //[TestCase("t", 0x00000001, (long)0x5db1831e)]
    ...
    //[TestCase("testy1", 0x00000001, (long)0x33925ceb)]
    ////[TestCase("testy12", 0x00000001, 0xd92c9f23)]
    //[TestCase("testy123", 0x00000001, (long)0x3bc1712d)]
    //[TestCase("special characters açb↓c", 0x00000001, (long)0x293327b5)]
    //[TestCase("The quick brown fox jumps over the lazy dog", 0x00000001, (long)0x78e69e27)]
    public void Digest_WithSeed_Returns_ExpectedValue(string actualString, int seedHex, uint expectedHex)
    {
